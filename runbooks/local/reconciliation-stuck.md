...
- **admission webhook denied** — kyverno rejected a pod/job; events show `admission webhook ... denied the request: Policy <name> failed`. Size the workload or add a scoped PolicyException (`policies-config/`), per [manifests/bases/policies/README.md](../../manifests/bases/policies/README.md)
